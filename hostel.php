...
<div class="chairman">
    ...
    <h1>Hostel</h1>
        ...
        <img src="assets/images/hostel-page.png" width=100% alt="">
        <p>For many people, coming to college means living away from home for the first time in their lives. So you want to be sure you’ll find a place to live that is clean, comfortable and safe. Not too expensive and within easy reach of hanging out zones. You’ll also want to be with students of other nationalities who share the same lifestyle as your own. Hostel represents a cross-section of the population and the society. Young people from different states, regions, nationalities, economic and social strata, speaking different languages, eating and dressing differently, professing diverse faiths, all come together imbued with a common purpose:
        ...
        <tr>
            ...
            <tr>
                <td>Non-AC-3 Sharing</td>
                <td>&#8377;98000</td>
            </tr>
            <tr>
                <td>Non-AC-4 Sharing</td>
                <td>&#8377;83000</td>
            </tr>
