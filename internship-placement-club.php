...
<div class="container">
    <div class="chairman">
        <div class="chairman-text">
            <h1>Internship & Placement Club</h1>
            <hr class="lines">
            <hr class="orange-line">
<img height="500px" width="1000px" src="assets/images/intern.jpg" class="responsive">
<p>
<h3>“In a world where competition grows by the minute and multiplies by the hour, placements have become a yardstick for excellence.”</h3>
<br><br>
...
<br><br>
Get yourself register for further details drop a mail to-  gilplacement@geeta.edu.in
<br><br>
